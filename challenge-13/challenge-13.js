...
(function () {
  ...
  */
  var removeStateOne = brasil.shift(0);
  console.log('\nEstado removido:');
  console.log(removeStateOne)
  // ?
  ...
  */
  var isThemSeven = brasil.every(function (item) {
    return item.length > 7;
  });

  console.log('\nTodos os estados de `brasil` tem mais de 7 letras?');
  // ?
  isThemSeven ? console.log("Sim, todos os estados tem mais de 7 letras!") : console.log("Nem todos os estados tem mais de 7 letras!");
  ...
  */
  var isHaveCeará = brasil.some(function (item) {
    return item === 'Ceará';
  });
  console.log('\nCeará está incluído em `brasil`?');
  // ?
  isHaveCeará ? console.log("Ceará está incluído!") : console.log("Ceará não foi incluído :(");
  /*
